...
const PaginationPrevious = React.forwardRef<HTMLButtonElement, ButtonHTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => (
    <PaginationLink
      ref={ref}
...
const PaginationNext = React.forwardRef<HTMLButtonElement, ButtonHTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => (
    <PaginationLink
      ref={ref}
...
const PaginationEllipsis = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span aria-aria-disabled="true" className={cn("flex h-10 w-10 items-center justify-center", className)} {...props}>
