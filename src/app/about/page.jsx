      ...
      <div className="relative bg-gradient-to-r from-orange-500 to-red-500 min-h-[400px] flex items-center">
        <div className="container mx-auto pr-10 flex items-center justify-between">
          ...
          <div className="flex-1 text-right">
            <h1 className="text-white justify-center text-6xl font-bold tracking-wider">
              ABOUT US
            </h1>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-black text-white pt-16 overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8">
            <button className="bg-gradient-to-tr from-[#d42027] to-[#f15a24] text-white font-[400] py-4 px-8 text-3xl transition-colors duration-300">
